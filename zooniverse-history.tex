...
Thus, while a substantial quantity of useful work can be done by the so-called ``one hit wonders'' described earlier, having a core community propelled many of the later project launches, bringing quick attention and results far faster than traditional recruitment mechanisms could.  
