...
\begin{center}
\small
\begin{tabular}{lllp{1.5cm}p{1.5cm}p{1.0cm}p{1.0cm}p{1.5cm}p{1.5cm}}
\hline
Project & Classifications & Favourites & Favourites per Classif. & Favourite workflow & Talk items & Talk items per classif. & Talk items per Subject & Talk workflow \\
\hline
\hline
...
Notes from Nature & 209,169 & - & - & none & 4,208 & 2.0\% & & ad hoc (h \& c), prompted (o) \\
