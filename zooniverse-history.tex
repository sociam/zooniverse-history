...
The most discussed theme was that of citizen-led discoveries, which were not originally anticipated by either the Zooniverse nor science teams.  The original workflow intended of the Zooniverse, as with most conventional kinds of human computation, was  to apply the power of the crowd to essentially process a pre-specified set of subjects in a way that answered a particular specified set of scientific problem(s) articulated by the science team.  This workflow, illustrated by the `top path' of Figure \ref{fig:twopaths}, was successfully followed for a large number of scientific problems in Zooniverse, such as as deriving a morphological classification of galaxies (e.g. \cite{fortson2011galaxy}). 

However, the addition of \emph{discussion facilities} to the Zooniverse opened up another pathway, which became apparent under a month after the Galaxy Zoo Forum first launched, when the citizen participant responsible for finding the ``Voorwerp'' posted her message that would ultimately mark the project's first citizen-initiated discovery.  This second, serendipitous ``path to science'', illustrated in the bottom path of Figure \ref{fig:twopaths}, meant that scientific questions that had not been anticipated might be identified and investigated by citizens themselves with various degrees of autonomy from the science teams.
...
To better understand the process of citizen-initiated investigation and discovery, we consulted with the Zooniverse team to identify a set of examples where the science team picked up on a citizen-initiated investigation and carried it through.  While this method may have omitted many instances of citizen-initiated investigations among the hundreds of thousands of comments in the forums, our goal was not to estimate the number of such leads but to understand how the interactions with the science teams unfolded.  

From the resulting list, four were selected that reflected a variety of citizen roles, summarised in Table \ref{tbl:serendipity}. For each example, we assembled all available written evidence for each, including discussion and talk posts, as well as notes made by the science team, and a few blog posts made by participants.  These were then analysed to identify the kinds of roles assumed by various citizens during each process and the resulting workflow.

Each of the four started with citizens bringing attention to something they saw in a subject during a task, although the purpose for making these posts varied; in two (Voorwerp and Convict Worm), the user was merely asking for help identifying the unknown object or species.  In Peas, meanwhile, the intention was primarily social, to attract attention to things that ``looked like peas''.  In the Kepler findings, the citizens already had a hypothesis that they had found something unusual and were both asking for help validating their hypotheses, and wishing to draw attention to these subjects for this reason.  

The degree of further citizen involvement also varied among the four examples. For the Voorwerp discovery, the science team essentially immediately took over the investigation after the volunteer pointed it out.   In the other examples, however, there was more interaction between citizens and the team.   In the Peas case, citizens self-organised to collect samples for an entire year after the first post, during which the science team had not noticed or taken significant interest in this thread.  (The so called self-organised ``pea hunters'' even called themselves the  ``Peas Corps'' \cite{story-of-the-peas}).  The convict worm, case illustrates an example where the science team quickly identified that the worm being identified might be an undiscovered species, and asked citizens for more help finding similar examples, which they did \emph{en masse}.  Finally, with the Kepler discovery, the users essentially performed their hypothesis forming and validation, consisting of modelling and light curve analysis.  This, done entirely independent of the science team, was then brought to the team's attention when complete.
...
\hline
\emph{Myth:} Adding pre-task tutorials boosts task performance & The Zooniverse team saw that tutorials increased bounce rates dramatically with no perceived effects on performance; instead, \emph{in-task guidance} was more effective at getting individuals involved. \\
...
In the previous section, we described the key experiences that shaped the way the Zooniverse team regarded the design of projects, pertaining to supporting serendipitous discovery, sustaining engagement, and planning project launches. In order to identify concrete design recommendations from this experience, we re-visited the Zooniverse team to reflect back to the beginning of the project, and to help frame the their experiences in terms of \emph{anti-patterns} or misconceptions likely to occur as citizen-science designers.  This was done because the notion of patterns or anti-patterns is common to many design fields, including architecture, software engineering and UX design, as a way to document recommendations in complex design spaces \cite{alexander2006pattern}.  The result of this process are the myths visible in Table \ref{tbl:myths}.

Despite the diversity of scientific fields represented by the Zooniverse projects, this analysis centred upon a single family of projects that feature common characteristics that may not be generally true across all citizen science projects.  For example, the primary goal of all of the Zooniverse projects is \emph{scientific outcomes and discovery}, while other citizen science systems may have different, even multiple, priorities. Educating users, for instance, was not among the team's design goals, which is reflected in decisions such as that to reduce the tutorials, explanations and feedback to the minimum necessary to complete tasks.  While effective at maximizing users' time on tasks, this had the effect that users did not readily gain skill in task performance over time, as evidenced by the fact that experienced users rarely outperformed new ones.   A second characteristic was that, as previously found (in \cite{raddick2010galaxy}), intrinsic motivation, that is, the desire to assist science, was responsible for the citizen participation among the Zooniverse projects.  This influenced strategic choices made by the team as such whether and how to communicate scientific milestones to participants to provide frequent feedback to users about what their efforts have enabled.  It was also seen to even inspire the science teams to conduct investigations and prepare articles expediently, as it was often felt that they ``owed it to the users'' to deliver on their commitment to publish results, given the dedication of the citizen community.  Finally specific characteristic of Zooniverse is that, as described earlier, its tasks are focused on \emph{classification}, rather than data collection or problem solving.  While it is possible that our observations may generalise to other kinds of tasks, we refrain from making such claims given the complexity of understanding the many design dimension of these systems.

Looking forward, while the Zooniverse team achieved significant success with respect to enabling scientific discovery through the participation of its nearly million users, the team perceives that their investigation remains very unfinished.  For one, many significant challenges pertaining to improving the mechanisms and means by which citizens can initiate, lead and coordinate investigations remain.  This has affected further planned improvements to Talk, so that disparate discussions on similar topics can be easily brought together by users.  But more critically, the team want to open up the facility for enabling citizens to carry out with more  the resources that currently the scienm
