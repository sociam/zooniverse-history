...
The paper summarises a grounded thematic analysis carried out with the Zooniverse team to identify the key lessons that were learnt whilst performing their iterative project design and launching process.  Our analysis was conducted using a mixed-methods approach, drawing upon both qualitative sources, including interviews with team members, discussion forums and blog posts, and quantitative sources, including time-series statistics of each project since launch.  Our aim was to allow perspectives on the complicated design space in which citizen-science projects come into existence to be shared with both UX practitioners interested in designing such systems, as well as to contextualise these findings against the growing body of crowdsourcing and online community studies within HCI.
