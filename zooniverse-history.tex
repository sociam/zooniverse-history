...
\caption{Summary of Zooniverse projects past and present, including each project's status as of September 2013.  The 1.68 million assets in the various Galaxy Zoo projects are not unique, since galaxies in GZ1 were used in subsequent projects. Solar Stormwatch and NEEMO projects presented live feeds from scientific instruments and thus had no quantifiable subject count. Domains: S -- space; C -- climate; H -- humanities; N -- nature; B -- biology. Tasks: C -- classifying; M -- marking; T -- transcribing. Projects marked with a * have been retired.}
\end{center}
\end{table}
