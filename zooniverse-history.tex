...
Despite the diversity encompassed by the academic disciplines represented by the Zooniverse projects, it should be clarified that this paper has only focused on a single, related family of projects that feature several common characteristics.  First, the design objective of all of the Zooniverse projects has, and will continue to be \emph{scientific outcomes and discovery}, while other kinds of citizen science systems may have different or multiple main purposes.  For example, while other systems may prioritise \emph{educating users}, this was not among the Zooniverse's goals, and is reflected design choices such as providing the minimum possible level of guidance and explanations to users necessary for them to effectively contribute.  A second specific characteristic of Zooniverse is that, as described earlier, its tasks are focused on \emph{classification}, rather than data collection or problem solving; the observations are likely to be specific to this category of tasks and not others discussed in this paper.
