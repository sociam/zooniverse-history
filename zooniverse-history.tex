...
\begin{center}
\small
\begin{tabular}{lllp{1.5cm}p{1.5cm}lp{1.5cm}p{1.5cm}}
\hline
Project & Classifications & Favorites & Favorites per Classification & Favoring workflow pattern & Talk items & Talk items per Asset & Talk workflow pattern \\
\hline
\hline
Galaxy Zoo 2 & 7,907,151 & 218,405 & 0.028 & ad hoc & 89,956??? & & a posteori, interposed dialogue \\
Galaxy Zoo Hubble & 7,458,781 & 214,101 & 0.029 & ad hoc & ??? & & a posteori, interposed dialogue \\
Planet Hunters & 19,179,696 & 201,508 & 0.011 & ad hoc & 427,917 & & a posteori, interposed dialogue \\
Andromeda Project & 1,091,406 & 5,874 & 0.005 & a posteori & ??? & & a posteori, interposed dialogue \\
Snapshot Serengeti & 7,800,896 & 116,758 & 0.015 & ad hoc & 39,250 & & a posteori, interposed dialogue \\
Planet Four & 3,900,785 & 40,657 & 0.010 & ad hoc & 32,097 & & a posteori, interposed dialogue \\
Cyclone Center & 218,317 & 1151 & 0.005 & a posteori & 1615 & & a posteori, interposed dialogue \\
Notes from Nature & 209,169 & - & - & no favoring & 4,208 & & ad hoc (herbaicum and cabug), a posteori, interposed dialogue (ornithological) \\
Space Warps & 7,037,472 & 34,977 & 0.005 & ad hoc & 20,978 & & ad hoc \\
Worm Watch Lab & 90,350 & 438 & 0.005 & a posteori, interposed dialogue & 855 & & a posteori, interposed dialogue \\
\hline
\end{tabular}
...
As can be inferred from this, Zooniverse projects draw a substantial number of contributors from the pre-existing community. The Andromeda Project, mentioned above, was completed in a mere sixteen days, meaning all subjects were classified and tasks completed fully, due to pre-existing community.  Without this community, would have taken much longer.  Finally, there is always a certain quantity of ``luck'' involved.  Such luck - serendipitous connections resulting from attention from major media outlets, for example, can seed a project with a sudden spike in user interest. Zooniverse has benefitted  from coverage across many major media outlets worldwide, including BBC programmes \emph{The Sky At Night} and \emph{Click}, as well as being featured as a cover story by \emph{National Geographic}.  
...
\emph{Myth:} Gameification sustains participation &  No, most of the reasons people participate in citizen science are intrinsic; gameification can interfere with such intrinsic motivations by introducing extrinsic rewards.  Better to support the intrinsic needs of the community \\
...
\emph{Myth:} Non-pictorial visual data are hard to undestand &  Users fared well in \emph{Planet Hunters} who were given the ``raw'' light curves and little explanation of their significance \\
