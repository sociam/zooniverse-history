...
The Galaxy Zoo project alone has published thirty nine papers, including a catalogue of galaxy morphologies \cite{lintott2008galaxy} and papers on its two most famous discoveries, the ``Hanny's Voorwerp" \cite{lintott2009galaxy} and the ``Green Peas", a class of galaxy \cite{cardamone2009galaxy}. Raddick et al also studied the motivations of project participants \cite{raddick2010galaxy}. Each Zooniverse project has its own blog providing updates, with a Zooniverse blog providing major news about each project, as well as information on publications and more general Zooniverse updates \footnote{The blog can be found at: \url{http://blog.zooniverse.org}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.43\textwidth]{imgs/twopaths.png}
