...
Over the course of different projects, the team devised projects for many different kinds of tasks and datasets from a variety of domains.  As these projects were launched, it became clear some experienced far greater participation than others.  This led the team to enquire whether it was the the task itself, data set, or domain that most influenced participation.  

Overall, the team concluded that no influence of domain
...
Initially, the team intended to use subjects which contained extracted weather data, simplifying the task while preventing users from seeing the additional items which were of no interest to the science team. 
