...
In this paper, we contribute a detailed case-study of a unique citizen-science platform, \emph{The Zooniverse} \footnote{The Zooniverse \url{www.zooniverse.org}}, which expanded from a single domain experiment to a ``factory for citizen science'', an authority for generating successful web applications for scientists across domains.  This was achieved through an iterative process involving designing a family of different applications for particular science projects, culimating in 27 projects total by September 2013.  This experience allowed the team to explore design decisions and gain insights at mutiple levels, from the interface/intraction flow, to the design of social elements (discussion forums), to external considerations such as ways to best launch and sustain prolonged engagement through external communications.  % Zooniverse also represents the first system in which volunteer contributions directly resulted in the publication of scientific findings in academic journals, contributing findings to at least $P$ published scientific papers.  

In this paper, we summarise the results of a retrospective reflective thematic analysis conducted by key members of the Zooniverse team, to identify key insights and consequences of design decisions that were gained through the often trial-and-error process.  The goal of the this analysis was to document the informal knowledge gathered on how to design and launch successful citizen science projects, and to derive an undestanding of the factors that may be responsible for the observations made. 
