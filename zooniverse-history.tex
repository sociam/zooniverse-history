...
\emph{Myth:} Experienced / advanced users perform better than new users &  No support was seen for this. \\
\emph{Myth:} Citizen science projects have to be `gameified' &  Many different kinds of things motivate individuals to participate in citizen science, but a majority of these motivators are intrinsic.  Gameification has been found to reduce intrinsic motivation in previous studies. \\
\hline
\end{tabular}
...
\section{Next steps for Zooniverse and Citizen Science}
