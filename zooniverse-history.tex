...
Towards this goal, the team identified what at least two key factors - the intrinsic ``interesting-ness'' of the subject to participants, and the overall difficulty of the task.  Pertaining to the first, there were many examples of projects which had an abundance of beautiful photos that appealed to the general audience, and it was these projects that exhibited the greatest user retention as well as attracted the most users.  In particular, Galaxy Zoo, which features a large number of beautiful photos of galaxies and deep space, and Snapshot Serengeti, which features an abundance of ``candid'' photos of popular animals in the wild were each 
