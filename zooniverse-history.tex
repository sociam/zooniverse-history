...
In the following sections, we briefly describe four examples of citizen-initiated investigations leading to discoveries, comparing the processes and roles assumed by citizens in each.  We then discuss the implications of these findings on the design of these forums, and highlight the factors that led to \emph{Talk}, the next iteration of the forum design.
