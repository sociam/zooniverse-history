...
In this paper, we present an analysis of a citizen-science platform called \emph{Zooniverse} \footnote{Zooniverse - \url{www.zooniverse.org}}, which evolved from a one-time experiment in crowdsourced data analysis for astronomy, into a ``factory for citizen science'', a venerable authority for successful Web citizen-science applications across academic disciplines. As of September $2013$, Zooniverse-assisted scientific findings have been published in over (TODO -- $57$) journal articles within both the natural sciences and the humanities, through the sustained effort of a dedicated and efficacious community of more than $800,000$ volunteers.  This community has demonstrated a number of impressive achievements, from completing entire new projects and datasets from hours to days after release, to initiating and pursuing independent lines of inquiry based on curiosities they found in datasets, which ultimately resulting unanticipated scientific findings.   

While the specific discoveries made with Zooniverse have been documented (e.g., \cite{lintott2008galaxy,lintott2009galaxy,story-of-the-peas,simpson2013dynamic}), the insights gained by the team through the iterative process of designing, deploying, and managing the over $27$ citizen-science projects that have launched at the time of this writing has not previously been captured. To this end, we conducted a thematic analysis of insights and experiences gained by the Zooniverse team, which were elicited through a triangulation method that drew upon both qualitative and quantiative sources, including interviews with team members, discussion forums and blog posts, and classification databases.  Our objective was to identify the ways that the team's concrete experiences and project outcomes influenced they way they, in turn, designed and managed citizen science projects.  In so doing, we sought to understand the team's view on the citizen science's future, and gaining an understanding of the HCI challenges that remained.
...
In order to identify the key insights that most influenced the decisions the team made when designing, launching and conducting new projects, we started with a mixed-method triangulation approach \cite{olsen2004triangulation} drawing from a mix of qualitative and quantitative sources.  The primary source of qualitative knowledge were interviews with the core members of the Zooniverse team themselves, comprising the lead project founder, lead team architect, as well as two members of the Galaxy Zoo design team.  These individuals were chosen because they were instrumental to both getting the project going at the beginning, and because they played instrumental roles in the decision-making processes throughout.  Interviews were loosely based around a set of questions (see Table \ref{tbl:questions}) that were designed to elicit reflections on the process and identify what was learnt along the way.   We conducted four interview sessions, two on one day, and two after the results of the first day were thematically arranged using a grounded thematic analysis.  While the goal of the first interviews were to generate a list of insights, the goal of the second set were to reflect the themes that were derived back at the team and gain in-depth insight.  Prior to the interviews and during the thematic analysis we also drew upon Forum discussion boards for four Zooniverse projects, and the Talk pages for thirteen projects, as well as twenty six Zooniverse-related blogs. These blogs included all currently active project blogs and an overarching Zooniverse blog maintained by all members of the team.
...
In this section, we present the results of our analysis, centering on the three dominant themes, due to space constraints.
...
All four began with a user calling attention to something they encountered during a task, although the purpose for making these posts varied; in two (Voorwerp and Convict Worm), the user was merely asking for help identifying an unknown object they saw.  In Peas, meanwhile, the intention was primarily social, to merely comment that there were  things that ``looked like peas''.  In the Kepler findings, meanwhile, the citizens involved already had a hypothesis about what they had found, and essentially already partially investigated their hypothesis by the time they called attention to these subjects.  

The degree of further citizen involvement also varied among the four examples. For the Voorwerp discovery, the science team essentially immediately took over the investigation after the volunteer pointed it out.   In the other examples, however, there was more interaction between citizens and the team.   In the Peas case, citizens self-organised to collect samples for an entire year after the first post, during which the science team had not noticed or taken significant interest in this thread.  (The so called self-organised ``pea hunters'' even called themselves the  ``Peas Corps'' \cite{story-of-the-peas}).  The convict worm, meanwhile, case illustrates an example where the science team quickly identified the item might be of interest, and then, turned  to citizens for help.  Finally, with the Kepler discovery, as previously nentioned, the users conducted an entire hypothesis validation process, consisting of modelling and light curve analysis, using their own sets of tools.  They then presented this evidence together as professional scientists would have.
