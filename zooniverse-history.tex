...
One of the key themes arising from post-hoc analysis of Zooniverse outcomes was focus on citizen-led discoveries, which were originally unanticipated by the team when launching Galaxy Zoo.  Although there was an awareness that some of these discoveries may have occurred merely with citizens bringing their findings to the attention of the science team via e-mail or other mechanism, in practice this would not have been feasible at scale without the discussion forums.  Therefore, it was viewed that it was the forums that served as the key enabler which set both the environment and the mechanism for allowing these discoveries to be made, and noticed by the science teams.

Here we first illustrate several key citizen-led initiatives, in order to convey the ways the discussion forums were used and the key players that participated in each discovery.  We then discuss the ways that the Zooniverse team refined the design of the discussion forums to better support distributed collaborative discovery-making.§§

\subsubsection{History of Citizen-Initiated Discoveries}
\begin{figure}
\centering
...
\subsubsection{Individual Citizen-Led Discovery: \emph{Hanny's Voorwerp}}
...
\subsubsection{From Discussion to Effective Collaboration: \emph{Talk}}
