...
% Consistent with visitation patterns to most web sites \cite{}, it was observed that visitors to the Zooniverse apps were increasingly likely to leave the site every passing moment on the site, than to stay.  Therefore, engaging users to tasks immediately maximized the amount of potential participation overall.  Even more the likelihood of a later return to the site was (Over half of the classifications were contributed by users who never returned. This of course, has significant implications 
...
% A key factor is 'stickiness' / inherent interestingness of the subject...

By no surprise, a key factor that sustains participant motivation is pertains to interesting-ness of the subjects themselves.  For example, those who witness ``beautiful'' galaxies in Galaxy Zoo, a subject containing fun/intersting/cute animals in Snapshot Serengeti, will stay longer and perform more classifications than those who did not see said images.  To measure this, we identified which subjects were most favourited, and examined whether those users who witnessed these subjects stayed longer, which was significant (Statistical measure). %TODO: Rob
...
\subsubsection{Achieving Low-Latency Interaction}
...
% Old Weather : Adding context  -does this help?
...
However, there was evidence that the ways that people get better at using the interface, and that they understand what they are doing with the interface better; for example, with Snapshot Serengeti they know how to distinguish the categories of animals directly without using the more laborouious decision tree interface for describing the animal's features.
...
\subsection{Myth $Z$: Abstract descriptions are harder}
...
% formally A-B testing them is prohibitive 
