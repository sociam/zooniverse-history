...
The Galaxy Zoo project published its first paper in 2008, which consisted of a catalogue of galaxies which had been morphologically classified through Galaxy Zoo \cite{lintott2008galaxy}. A further thirty eight papers have been published, including papers on its more famous discoveries: ``Hanny's Voorwerp", originally a mystery and now found to be a possible quasar light echo \cite{lintott2009galaxy} and ``Green Peas", a previously undescribed class of galaxy \cite{cardamone2009galaxy}.
...
In this section, we summarise the key themes pertaining to the design that emerged from our iterative thematic analysis conducted with the Zooniverse team.  Due to space constraints, we only include three here, which were deemed most important by both the impact these insights on the decisions made by the team, as well as on their relevance to the greater citizen-science/HCI community.
