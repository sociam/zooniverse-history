...
We also performed an initial quantitative analysis based on a snapshot of the entire Zooniverse databases which includes the user, classification and talk data (anonymised) of 14 different Zooniverse projects. This volume contains an overall amount of 250,044 registered users, 50,995,591 classifications, and 650,243 talk contributions.
