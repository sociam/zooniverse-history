...
\begin{table*}
\begin{center}
\begin{tabular}{p{1.6cm}p{1.5cm}p{1.4cm}p{8cm}p{0.5cm}p{0.68cm}p{0.68cm}p{0.88cm}}
\hline
Discovery & Date & Project & Description & C.I. & C.C. & C.V. & See also\\
\hline
...
\emph{Green Pea Galaxies} & July 2007-Aug 2008 & Galaxy Zoo 
   ...
   & y & y & n & \cite{story-of-the-peas,cardamone2009galaxy} \\
...
\emph{Kepler 16B} & May 2011 & Planet Hunters 
   ...
   & y & n & y & \cite{schwamb2013planet} \\
\end{tabular}
\caption{\emph{Citizen-led serendipitous discoveries} - Common myths associated with designing for citizen science, with the Zooniverse team's perspectives on each.}
\label{tbl:myths}
\normalsize
\end{center}
\end{table*}
